...
| Qwen 3.6 35B-A3B (NVFP4) | [01](../traps/reasoning/01-reasoning-field-two-names.md), [12](../traps/evaluation/12-empty-content-at-token-ceiling.md), [23](../traps/reasoning/23-streaming-answer-lands-in-reasoning-channel.md), [26](../traps/tools/26-tool-call-inside-unclosed-think.md), [44](../traps/evaluation/44-retry-on-truncation-residual-tail.md), [48](../traps/runtime/48-prefix-caching-autodisabled-hybrid.md) |
...
| Qwen 3.5 9B (Q4_K_M, llama.cpp) | [21](../traps/versioning/21-no-generation-config-server-defaults-win.md), [22](../traps/evaluation/22-family-card-budget-floors-differ-by-size.md), [44](../traps/evaluation/44-retry-on-truncation-residual-tail.md) |
...
| Qwen 3.6 27B (NVFP4 modelopt and GGUF; vLLM 0.23/0.24, llama.cpp) | [45](../traps/quantization/45-fp4-dequant-scale-swizzle-layout.md), [46](../traps/quantization/46-fa-all-quants-cpu-fallback.md), [47](../traps/versioning/47-stale-build-missing-arch-kernel.md), [48](../traps/runtime/48-prefix-caching-autodisabled-hybrid.md), [54](../traps/runtime/54-config-edit-never-took-effect.md) |
| Nemotron-H 8B Base (Mamba2 hybrid; llama.cpp KV-quant fork, CPU/Metal/CUDA) | [51](../traps/evaluation/51-hidden-state-dump-convention.md), [52](../traps/quantization/52-single-backend-nan-fused-path.md) |
| Nemotron-Labs TwoTower 30B-A3B (block diffusion, HF trust_remote_code) | [45](../traps/quantization/45-fp4-dequant-scale-swizzle-layout.md), [52](../traps/quantization/52-single-backend-nan-fused-path.md) |
| Gemma 4 family (12B / 26B-A4B / 31B, GGUF; Metal and Vulkan) | [53](../traps/evaluation/53-speed-measured-on-a-broken-config.md) |
| Qwen 2.5 7B-Instruct (GGUF; Metal and CUDA) | [56](../traps/quantization/56-kv-quant-unread-without-chunked-prefill.md), [57](../traps/evaluation/57-supported-context-is-not-trained-context.md) |

## Stack-level traps (apply to any model on that stack)

| Stack or layer | Traps |
|---|---|
| Eval harnesses and scorers | [05](../traps/evaluation/05-scorer-normalization-verdict-flip.md), [15](../traps/evaluation/15-no-echo-logprobs-wedges-lm-eval.md), [16](../traps/evaluation/16-finish-reason-is-not-a-failure-signal.md), [17](../traps/evaluation/17-per-arm-recommended-sampling-confound.md), [31](../traps/evaluation/31-leftover-oracle-reranker.md), [34](../traps/evaluation/34-baseline-you-degraded-yourself.md), [35](../traps/evaluation/35-identical-weights-do-not-score-identically.md), [36](../traps/evaluation/36-token-cap-is-an-arm-level-handicap.md), [37](../traps/evaluation/37-uniform-zero-is-a-harness-verdict.md), [40](../traps/evaluation/40-ngram-decontamination-false-positives.md), [42](../traps/evaluation/42-single-turn-harness-scores-tool-calls-as-wrong.md), [44](../traps/evaluation/44-retry-on-truncation-residual-tail.md), [50](../traps/evaluation/50-prompt-not-tokenized-to-target.md), [55](../traps/evaluation/55-run-order-and-warm-cache-artifacts.md), [57](../traps/evaluation/57-supported-context-is-not-trained-context.md) |
...
| llama.cpp attention and serve flags | [18](../traps/runtime/18-flash-attention-off-halves-deep-decode.md), [19](../traps/tools/19-missing-jinja-breaks-tool-parsing.md), [43](../traps/template/43-tool-args-string-not-mapping.md), [46](../traps/quantization/46-fa-all-quants-cpu-fallback.md) |
...
| Local-network endpoints and client libraries (mDNS, dual-stack, SDK HTTP clients) | [49](../traps/routing/49-dual-stack-mdns-latency-tax.md) |
| Build and deploy provenance (which binary is actually serving you) | [47](../traps/versioning/47-stale-build-missing-arch-kernel.md), [54](../traps/runtime/54-config-edit-never-took-effect.md) |
| KV-cache quantization measurement | [46](../traps/quantization/46-fa-all-quants-cpu-fallback.md), [56](../traps/quantization/56-kv-quant-unread-without-chunked-prefill.md) |
| Kernel and numerics parity harnesses | [51](../traps/evaluation/51-hidden-state-dump-convention.md), [52](../traps/quantization/52-single-backend-nan-fused-path.md), [53](../traps/evaluation/53-speed-measured-on-a-broken-config.md) |
| Performance benchmarking generally (order, warm-up, clocks, prompt construction) | [50](../traps/evaluation/50-prompt-not-tokenized-to-target.md), [53](../traps/evaluation/53-speed-measured-on-a-broken-config.md), [55](../traps/evaluation/55-run-order-and-warm-cache-artifacts.md) |
