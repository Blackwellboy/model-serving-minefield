...
The doctor implements checks for **17 of the registry's 74 numbered entries**
(01, 02, 03, 04, 07, 10, 12, 16, 17, 19, 20, 21, 22, 23, 25, 26, 29). Every
run ends with a coverage line:

```
implemented 17/74 | executed on this stack N | clean N | problems N | inconclusive N | not implemented 25
```
