...
| Speculative-decode serve OOMs at startup or under concurrent traffic on unified memory | K x seqs product exhausts UMA; neither default (256) nor card-recommended (32) accounts for K | [98](traps/runtime/98-speculative-decode-default-max-seqs-oom-uma.md) | contributor-measured, conditions as reported |
