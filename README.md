...
| Speculative-decode serve crashes at startup or on first request on unified memory | `max-num-seqs` default (256) or card-recommended (32) exhausts UMA under DFlash | [98](traps/runtime/98-speculative-decode-default-max-seqs-oom-uma.md) | contributor-measured, conditions as reported |
