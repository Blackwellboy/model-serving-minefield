...
**Found by Nemo ([@smfworks](https://github.com/smfworks)), based on profiling by @Hikari_07_jp.**
...
[Hikari-knowledge vault](https://github.com/hikarioyama/Hikari-knowledge/blob/main/nodes/serving/step37-single-stream-ceiling.md).
Cross-referenced and contributed by Nemo ([@smfworks](https://github.com/smfworks)). The Hikari-knowledge vault
