...
| [U42, required tool args disappear only under reported production state](U42-glm53-blank-required-tool-args-only-under-production-state.md) | GLM-5.3 / glm47 / production concurrency | maintainer responded | open |
