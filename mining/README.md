...
| 2026-07-28 | [SGLang NVFP4 generation and doctor portability on DGX Spark](2026-07-28-sglang-nvfp4-and-doctor-dgx-spark.md) | **Q7 refuted under its first-generation criterion; Q8 confirmed.** A Nemotron NVFP4 control generated first, Laguna loaded its compressed-tensors NVFP4 MoE path and generated a correct first token, and two 14-request doctor runs produced meaningful verdicts. Longer Laguna output remained degraded, so this is not a correctness claim. Adds contributor-measured SGLang surfaces to traps 02, 12 and 77 and fixes stack identification |
