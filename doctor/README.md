...
The doctor implements checks for **19 of the registry's 116 numbered entries**
(01, 02, 03, 04, 07, 10, 12, 16, 17, 19, 20, 21, 22, 23, 25, 26, 29, 77, 78).
Every run ends with a coverage line:

```
implemented 19/116 | executed on this stack N | clean N | problems N | inconclusive N | not implemented 97
```
...
- The remaining **97** numbered traps have no check in this tool.
