...
- **U18** — explicit `tool_calls: []` on streamed content deltas can make JavaScript clients route valid text into the tool branch and display no answer. Source: merged PR #17, @hhackbarth.
...
- **U22** — the DSpark draft loader silently skipped twelve shared-expert tensors at DEBUG level; target verification kept quality correct while acceptance and throughput collapsed. Source: commit `8a62e8b8`, @tonyd2wild.
