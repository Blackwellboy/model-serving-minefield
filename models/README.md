...
| MiniMax-M3 | [08](../traps/runtime/08-image-toolchain-newer-than-driver.md), [109](../traps/template/109-inline-system-role-is-not-a-stable-contract.md) |
| GLM-5.1, GLM-5.2, Kimi-K2.6, Kimi-K3, MiniMax-M2.5 and MiniMax-M2.7 (pinned public template/tokenizer artifacts) | [109](../traps/template/109-inline-system-role-is-not-a-stable-contract.md) |
