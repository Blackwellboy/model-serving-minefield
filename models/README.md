...
| llama.cpp server introspection and slot accounting | [87](../traps/runtime/87-llamacpp-props-reports-per-slot-context.md), [88](../traps/runtime/88-cache-prompt-false-does-isolate-here.md), [46](../traps/versioning/46-stale-build-missing-arch-kernel.md) |
