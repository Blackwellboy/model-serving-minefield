# Trap 50: the benchmark prompt does not tokenize to the length you named

**Found by TheTom.**

**Status: reproduced here.** Caught by an internal consistency check; the corrected numbers replaced
the original set.
...
Runnable: [`checks/tokenized_length_assert.py`](../../checks/tokenized_length_assert.py).
