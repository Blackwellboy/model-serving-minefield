...
| Qwen 3.6 27B (Q4_K_M, llama.cpp) | [22](../traps/evaluation/22-family-card-budget-floors-differ-by-size.md); control case in [21](../traps/versioning/21-no-generation-config-server-defaults-win.md) |
...
|---|---|---|
| Ternary-Bonsai-27B MLX 2bit on mlx server (Apple silicon) | 2026-07-27 | Sane completions, no stray or unbalanced think tags, no reasoning-field surprises, structured tool_calls work (correct name and arguments) |
