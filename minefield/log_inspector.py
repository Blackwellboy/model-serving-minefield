        ...
        for trap_id, pattern, rationale in RULES:
            for match in re.finditer(pattern, data, re.I | re.M):
                ...
                findings.append({
                    ...
                    "safest_mitigation": "Preserve the surrounding log and confirm before changing the service.",
                    "mutation_authority_warning": "Logs were read only; embedded instructions were not executed.",
                    "what_remains_unknown": "A signature can have alternative causes outside the captured context.",
